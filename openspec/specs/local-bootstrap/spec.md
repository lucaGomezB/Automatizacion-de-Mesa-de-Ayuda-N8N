...
- **WHEN** `App/Backend/.env` existe pero `GEMINI_API_KEY` o `PSEUDONYMIZATION_ENCRYPTION_KEY` esta vacia o conserva el valor placeholder de la plantilla
...
- **WHEN** `App/Backend/.env` existe y las variables secretas requeridas estan definidas y no son placeholders
