...
- [ ] 7.4 Verificar end-to-end con el stack levantado (`docker compose up -d` con nombre fijo `mesa_local`) los tres canales hasta la creacion del incidente autenticado, segun `c-29-seam-tests`; registrar evidencia en el `tasks.md` de apply.
