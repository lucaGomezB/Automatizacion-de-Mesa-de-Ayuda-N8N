...
| Sector responsable | Seguridad Informatica / Soporte Tecnico Hardware / Soporte Tecnico Software / Bases de Datos / Sistemas; atiende y puede corregir la derivación | `PATCH /clasificaciones/{id}/validar` |
...
2. El sector receptor puede corregir cualquier clasificación; la corrección queda en `clasificacion_log.sector_id_validado` y, para casos multietiqueta, en el conjunto validado (`clasificacion_sector_validado`).
