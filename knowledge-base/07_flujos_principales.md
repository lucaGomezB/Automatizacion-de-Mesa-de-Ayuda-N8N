...
3. `HybridClassifier`: etapa deterministica -> si confianza >= 0,90 decide; si no -> pseudonimizar (C-03, implementado en `utils/pseudonymizer.py`) -> Gemini -> validacion de respuesta (RN-VA) -> si todo falla, fallback.
