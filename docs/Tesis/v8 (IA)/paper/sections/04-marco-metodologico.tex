...
La investigación se desenvolvio bajo un protocolo de observación naturalista: los operadores sabían que se estaba utilizando el nuevo sistema para el procesamiento de incidentes, pero el operador cuyo tiempo se registraba no fue informado de que sería cronometrado. De este modo su desempeño permaneció indistinguible de la práctica laboral regular y se evita el efecto Hawthorne ---la alteracion del comportamiento de los sujetos cuando saben que estan siendo observados--- \parencite{HernandezSampieri2018_metodologia}. La medición del tiempo se realizó de forma diferenciada según el flujo. En el flujo automatizado se utilizaron registros automáticos del propio sistema (marcas de tiempo de entrada y salida en la base de datos, con precision al milisegundo). En el flujo manual, los operadores trabajaron en pares y el tiempo lo cronometró en vivo el compañero que no estaba registrando el incidente, consignándolo en una planilla de cronometraje: se registró el tiempo total de registro de cada incidente en segundos, con la mayoría de los valores estimados y redondeados a múltiplos de 5~s y unos pocos conservados con exactitud al segundo, sin fracciones de segundo.
