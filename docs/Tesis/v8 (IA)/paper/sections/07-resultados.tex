...
La medición de la intervención humana se realizó cronometrando, sobre cada caso, los segundos en que el operador ejecuto acciones manuales sobre el sistema. En el flujo manual, el 100~\% del tiempo correspondio a intervención humana, incluyendo lectura, comprension, busqueda en sistemas auxiliares y carga del ticket. En el flujo automatizado, el operador humano solo intervino en aquéllos casos en los que el clasificador devolvio una confianza inferior al 70~\% o en los que el sector responsable, al recibir el ticket, identificó una clasificación incorrecta y la corrigio antes de iniciar la atención.
