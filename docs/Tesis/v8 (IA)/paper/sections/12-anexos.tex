...
\begin{itemize}
  \item \textbf{Diagrama de despliegue}: los cinco componentes principales (N8N, FastAPI, PostgreSQL, Gemini~2.5 Flash, Twilio), el proxy inverso Nginx que provee terminación TLS~1.3 en el perímetro del sistema, y las relaciones de comunicación entre ellos.
